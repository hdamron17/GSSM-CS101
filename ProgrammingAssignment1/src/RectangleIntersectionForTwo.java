...
public class RectangleIntersectionForTwo {
	public static void main(String[] args) {
		...
		Rectangle r1, r2, r3, r12, r23, r31, rall; //Declarations of all Rectangles		
		boolean out = false; //Boolean to test if anything is outputted to determine if a no intersection is appropriate
		int two = 0;
		while(two != 2) {
			two = 0; //Counts up until there are two intersections exactly
			...
			if(r1.intersects(r2)) { //Continues to create intersection of r1 and r2 if any
				r12 = new Rectangle(); //Generates Rectangle r12
			...
			if(r3.intersects(r1)) { //Continues to create intersection of r3 and r1
				r31 = new Rectangle(); //Generates Rectangle r31
				...
				if(r31.intersects(r2)) { //Continues to create intersection of r31 and r2 which is the intersection of all three if any
					rall = new Rectangle(); //Generates Rectangle rall
			...
			out = false; //Resets out to false
			System.out.println(""); //Separates runs with a blank line
		}
	}
}
